...
def callback(data):
    global up,down,left,right,left_bottom,right_bottom,obstacle,sleft,sright,hright,hleft
    rot = rospy.ServiceProxy('anglediff',angle)
    if str(data.data) == "up" and up == 0 and obstacle != True:
        drive_motor(500,500,1,0)
        up = 1
    elif str(data.data) == "down" and down == 0 :
        drive_motor(500,500,0,1)
        down = 1
        ...
        left_bottom = 600
        sleft = 1
    elif str(data.data) == "rsleft" and sleft == 1:
        left_bottom = 500
        sleft = 0
    elif str(data.data) == "sright" and sright == 0:
        right_bottom = 600
        sright = 1
    elif str(data.data) == "rsright" and sright == 1:
        right_bottom = 500
        sright = 0
