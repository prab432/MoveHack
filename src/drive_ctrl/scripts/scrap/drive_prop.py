...
def callback(data):
    ...
    move=str(data.data).split(",")
    if gtg == True :    
        if move[0] == "up" and up == 0 and obstacle != True:
            drive_motor(800,800,1,0) #500
            up = 1
        elif move[0] == "down" and down == 0 :
            drive_motor(600,600,0,1)
            down = 1
        elif move[0] == "right" and right == 0 :
            drive_motor(900,900,1,1)
            right = 1
        elif move[0] == "left" and left == 0 :
            drive_motor(900,900,0,0)
            left = 1
        elif move[0] == "rup" and up == 1:
            stop_motor()
            up = 0
        elif move[0] == "rdown" and down == 1:
            stop_motor()
            down = 0
        elif move[0] == "rleft" and left == 1:
            stop_motor()
            left = 0
        elif move[0] == "rright" and right == 1:
            stop_motor()
            right = 0
        elif move[0] == "stop":
            stop_motor()
        elif move[0] == "sleft" and sleft == 0:
            left_bottom = 800
            sleft = 1
        elif move[0] == "rsleft" and lleft == 1:
            left_bottom = 800
            right_bottom= 800
            lleft = 0
            sleft=0
        elif move[0] == "sright" and sright == 0:
            right_bottom= 800
            #left_bottom = 800
            sright = 1
        elif move[0] == "rsright" and lright == 1:
            right_bottom = 800
            left_bottom = 800 #500
            lright = 0
            sright=0
            ...
            delay=long(move[1])
            rospy.loginfo(delay)
            right_bottom = (700 - delay) 
            left_bottom = (700 + delay) #300
            time.sleep(0.1)
            lright=1
